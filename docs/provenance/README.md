...
chromadyn's method was extracted from an MCF7 ATAC-seq timecourse analysis.
...
those notebooks, and record which part of the original each piece of chromadyn
was ported from.
